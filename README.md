...
<b>Steps to do:</b>
<br>
- 3D print the parts. It is easiest on a Bambulab with AMS, but possible on a normal printer with two color changes.Print the two back covers with connectors so you can open up the construction after it is finished. <p></p>
